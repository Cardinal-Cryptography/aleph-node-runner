...
```bash
./run_node.sh --name <your_nodes_name> --ip <your IP>  --controller_account <validator_stash_account_id>
```
...
* `--controller_account`: provide `AccountId` of the stash account linked to your validator node. If you run as validator, then this argument is mandatory.
